<?php
$missaoAtual = 7; // Defina o número da missão atual

$title = "Trajetória 7 - A Vitória da Conexão Suprema";
...
$content = '
 ...
 <p class="fs-5 fs-sm-4 text-center"> Dentro do castelo, você encontra o Coração da Rede, uma joia que garante uma conexão perfeita. Para ativá-la, você deve… </p>

            <!-- Opções listadas -->
            <div class="opcao">
                <p class="mb-0 fs-6 fs-sm-5">1ª Opção: Tentar aumentar o poder da joia além do necessário.</p>
            </div>
            <div class="opcao">
                <p class="mb-0 fs-6 fs-sm-5">2ª Opção: Instalar a configuração correta e garantir que tudo funcione perfeitamente. </p>
            </div>
             <div class="opcao">
                <p class="mb-0 fs-6 fs-sm-5">3ª Opção: Remover a joia sem seguir o protocolo. </p>
            </div>
            ...
            <div id="buttonContainer" class="d-flex flex-column flex-md-row justify-content-around gap-3">
                <form method="POST" action="' . $BASE_URL . 'forms/engenheiro_opcoes.php" class="w-100">
                    <input type="hidden" name="opcao" value="19">
                ...
                <form method="POST" action="' . $BASE_URL . 'forms/engenheiro_opcoes.php" class="w-100">
                    <input type="hidden" name="opcao" value="21">
