...
$content = '
 ...
 <p class="fs-5 fs-sm-4 text-center">Você finalmente chega ao lendário Castelo do Ping Perfeito, onde a conexão nunca cai. Mas um antigo feitiço impede a entrada! </p>

            <!-- Opções listadas -->
            <div class="opcao">
                <p class="mb-0 fs-6 fs-sm-5">1ª Opção: Decifrar os símbolos antigos e desativar o feitiço.</p>
            </div>
            <div class="opcao">
                <p class="mb-0 fs-6 fs-sm-5">2ª Opção: Forçar a entrada com pura força.</p>
            </div>
             <div class="opcao">
                <p class="mb-0 fs-6 fs-sm-5">3ª Opção: Tentar hackear a barreira mágica.</p>
            </div>
